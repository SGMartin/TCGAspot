#!/usr/bin/env python3
"""
CNV filtering module: This script takes TCGA gene level copy number scores
generated by GISTIC-2 and filters them. In summary, ENSEMBL regions are mapped
to genes, cases are excluded based on annotations.txt and the whole data is 
reshaped to a more convenient (i.e. long) format. Regions with no CNV gain 
or losses are removed.
"""
